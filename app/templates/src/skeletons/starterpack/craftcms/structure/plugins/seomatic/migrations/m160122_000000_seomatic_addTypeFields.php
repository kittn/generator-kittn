 ...
 */
class m160122_000000_seomatic_addTypeFields extends BaseMigration
{
    /**
    ...
    public function safeUp()
    {
        ...
        $newColumns = array (
            'siteOwnerSubType' => ColumnType::Varchar,
            'siteOwnerSpecificType' => ColumnType::Varchar
        );

        $this->_addColumnsAfter("seomatic_settings", $newColumns, "siteOwnerType");

        // specify columns and AttributeType
        $newColumns = array (
            'siteCreatorSubType' => ColumnType::Varchar,
            'siteCreatorSpecificType' => ColumnType::Varchar
        );

        $this->_addColumnsAfter("seomatic_settings", $newColumns, "siteCreatorType");

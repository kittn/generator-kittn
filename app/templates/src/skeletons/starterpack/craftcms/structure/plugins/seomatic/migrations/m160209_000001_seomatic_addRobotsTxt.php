 ...
 */
class m160209_000001_seomatic_addRobotsTxt extends BaseMigration
{
	/**
	...
	public function safeUp()
	{
		...
		$newColumns = array (
			'siteRobotsTxt' => ColumnType::Text
		);

		$this->_addColumnsAfter("seomatic_settings", $newColumns, "siteRobots");

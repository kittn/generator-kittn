 ...
 */
class m160206_000000_seomatic_addGoogleAnalyticsPlugins extends BaseMigration
{
    /**
    ...
    public function safeUp()
    {
        ...
        $newColumns = array (
            'googleAnalyticsEcommerce' => ColumnType::Bool,
            'googleAnalyticsEEcommerce' => ColumnType::Bool,
            'googleAnalyticsLinkAttribution' => ColumnType::Bool,
            'googleAnalyticsLinker' => ColumnType::Bool,
        );

        $this->_addColumnsAfter("seomatic_settings", $newColumns, "googleAnalyticsAdvertising");

 ...
 */
class m160724_000000_seomatic_addSeoMainEntityCategory extends BaseMigration
{
	/**
	...
	public function safeUp()
	{
		...
		$newColumns = array (
			'seoMainEntityCategory' => ColumnType::Varchar
		);

		$this->_addColumnsAfter("seomatic_meta", $newColumns, "metaPath");

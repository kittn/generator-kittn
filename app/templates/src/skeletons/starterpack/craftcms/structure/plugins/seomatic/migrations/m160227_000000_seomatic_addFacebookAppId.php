 ...
 */
class m160227_000000_seomatic_addFacebookAppId extends BaseMigration
{
	/**
	...
	public function safeUp()
	{
		...
		$newColumns = array (
			'facebookAppId' => ColumnType::Varchar,
		);

		$this->_addColumnsAfter("seomatic_settings", $newColumns, "facebookProfileId");

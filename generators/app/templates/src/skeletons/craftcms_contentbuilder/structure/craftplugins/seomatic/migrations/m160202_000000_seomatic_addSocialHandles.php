 ...
 */
class m160202_000000_seomatic_addSocialHandles extends BaseMigration
{
    /**
    ...
    public function safeUp()
    {
        ...
        $newColumns = array (
            'youtubeChannelHandle' => ColumnType::Varchar,
        );

        $this->_addColumnsAfter("seomatic_settings", $newColumns, "youtubeHandle");

        // specify columns and AttributeType
        $newColumns = array (
            'githubHandle' => ColumnType::Varchar,
        );

        $this->_addColumnsAfter("seomatic_settings", $newColumns, "pinterestHandle");

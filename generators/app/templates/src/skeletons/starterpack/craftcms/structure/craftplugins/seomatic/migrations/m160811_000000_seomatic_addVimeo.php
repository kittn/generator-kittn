 ...
 */
class m160811_000000_seomatic_addVimeo extends BaseMigration
{
	/**
	...
	public function safeUp()
	{
		...
		$newColumns = array (
			'vimeoHandle' => ColumnType::Varchar
		);

		$this->_addColumnsAfter("seomatic_settings", $newColumns, "githubHandle");
        $this->alterColumn('seomatic_settings', 'vimeoHandle', array(ColumnType::Varchar, 'maxLength' => 50));

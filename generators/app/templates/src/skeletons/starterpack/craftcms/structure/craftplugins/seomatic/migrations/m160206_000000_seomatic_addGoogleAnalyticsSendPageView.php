 ...
 */
class m160206_000000_seomatic_addGoogleAnalyticsSendPageView extends BaseMigration
{
    /**
    ...
    public function safeUp()
    {
        ...
        $newColumns = array (
            'googleAnalyticsSendPageview' => ColumnType::Bool,
        );

        $this->_addColumnsAfter("seomatic_settings", $newColumns, "googleAnalyticsUID");

 ...
 */
class m160111_000000_seomatic_addTitleFields extends BaseMigration
{
    /**
    ...
    public function safeUp()
    {
        ...
        $newColumns = array (
            'siteSeoTitleSeparator' => ColumnType::Varchar,
            'siteSeoTitlePlacement' => ColumnType::Varchar
        );

        $this->_addColumnsAfter("seomatic_settings", $newColumns, "siteSeoTitle");

 ...
 */
class m160101_000000_seomatic_addRobotsFields extends BaseMigration
{
	/**
	...
	public function safeUp()
	{
		...
		$newColumns = array (
			'robots' => ColumnType::Varchar
		);

		$this->_addColumnsAfter("seomatic_meta", $newColumns, "openGraphType");

		// specify columns and AttributeType
		$newColumns = array (
			'siteRobots' => ColumnType::Varchar
		);

		$this->_addColumnsAfter("seomatic_settings", $newColumns, "siteOpenGraphType");

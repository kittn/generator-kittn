...
# Datenbank: joomla
# Erstellt am: 2018-04-24 23:09:07 +0000
# ************************************************************
...
# Export von Tabelle jokittn_assets
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_assets`;

CREATE TABLE `jokittn_assets` (
...
LOCK TABLES `jokittn_assets` WRITE;
/*!40000 ALTER TABLE `jokittn_assets` DISABLE KEYS */;

INSERT INTO `jokittn_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`)
VALUES
...
/*!40000 ALTER TABLE `jokittn_assets` ENABLE KEYS */;
UNLOCK TABLES;


# Export von Tabelle jokittn_associations
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_associations`;

CREATE TABLE `jokittn_associations` (
...
# Export von Tabelle jokittn_banner_clients
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_banner_clients`;

CREATE TABLE `jokittn_banner_clients` (
...
# Export von Tabelle jokittn_banner_tracks
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_banner_tracks`;

CREATE TABLE `jokittn_banner_tracks` (
...
# Export von Tabelle jokittn_banners
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_banners`;

CREATE TABLE `jokittn_banners` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
# Export von Tabelle jokittn_categories
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_categories`;

CREATE TABLE `jokittn_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `jokittn_categories` WRITE;
/*!40000 ALTER TABLE `jokittn_categories` DISABLE KEYS */;

INSERT INTO `jokittn_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`)
VALUES
	(1,0,0,0,11,0,'','system','ROOT',X'726F6F74','','',1,0,'0000-00-00 00:00:00',1,'{}','','','{}',860,'2018-04-19 12:31:56',0,'0000-00-00 00:00:00',0,'*',1),
	(2,27,1,1,2,1,'uncategorised','com_content','Uncategorised',X'756E63617465676F7269736564','','',1,0,'0000-00-00 00:00:00',1,'{\"category_layout\":\"\",\"image\":\"\"}','','','{\"author\":\"\",\"robots\":\"\"}',860,'2018-04-19 12:31:56',0,'0000-00-00 00:00:00',0,'*',1),
	(3,28,1,3,4,1,'uncategorised','com_banners','Uncategorised',X'756E63617465676F7269736564','','',1,0,'0000-00-00 00:00:00',1,'{\"category_layout\":\"\",\"image\":\"\"}','','','{\"author\":\"\",\"robots\":\"\"}',860,'2018-04-19 12:31:56',0,'0000-00-00 00:00:00',0,'*',1),
	(4,29,1,5,6,1,'uncategorised','com_contact','Uncategorised',X'756E63617465676F7269736564','','',1,0,'0000-00-00 00:00:00',1,'{\"category_layout\":\"\",\"image\":\"\"}','','','{\"author\":\"\",\"robots\":\"\"}',860,'2018-04-19 12:31:56',0,'0000-00-00 00:00:00',0,'*',1),
	(5,30,1,7,8,1,'uncategorised','com_newsfeeds','Uncategorised',X'756E63617465676F7269736564','','',1,0,'0000-00-00 00:00:00',1,'{\"category_layout\":\"\",\"image\":\"\"}','','','{\"author\":\"\",\"robots\":\"\"}',860,'2018-04-19 12:31:56',0,'0000-00-00 00:00:00',0,'*',1),
	(7,32,1,9,10,1,'uncategorised','com_users','Uncategorised',X'756E63617465676F7269736564','','',1,0,'0000-00-00 00:00:00',1,'{\"category_layout\":\"\",\"image\":\"\"}','','','{\"author\":\"\",\"robots\":\"\"}',860,'2018-04-19 12:31:56',0,'0000-00-00 00:00:00',0,'*',1);

/*!40000 ALTER TABLE `jokittn_categories` ENABLE KEYS */;
UNLOCK TABLES;


# Export von Tabelle jokittn_contact_details
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_contact_details`;

CREATE TABLE `jokittn_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
# Export von Tabelle jokittn_content
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_content`;

CREATE TABLE `jokittn_content` (
...
# Export von Tabelle jokittn_content_frontpage
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_content_frontpage`;

CREATE TABLE `jokittn_content_frontpage` (
...
# Export von Tabelle jokittn_content_rating
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_content_rating`;

CREATE TABLE `jokittn_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
# Export von Tabelle jokittn_content_types
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_content_types`;

CREATE TABLE `jokittn_content_types` (
...
LOCK TABLES `jokittn_content_types` WRITE;
/*!40000 ALTER TABLE `jokittn_content_types` DISABLE KEYS */;

INSERT INTO `jokittn_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`)
VALUES
...
/*!40000 ALTER TABLE `jokittn_content_types` ENABLE KEYS */;
UNLOCK TABLES;


# Export von Tabelle jokittn_contentitem_tag_map
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_contentitem_tag_map`;

CREATE TABLE `jokittn_contentitem_tag_map` (
...
# Export von Tabelle jokittn_core_log_searches
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_core_log_searches`;

CREATE TABLE `jokittn_core_log_searches` (
...
# Export von Tabelle jokittn_extensions
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_extensions`;

CREATE TABLE `jokittn_extensions` (
...
LOCK TABLES `jokittn_extensions` WRITE;
/*!40000 ALTER TABLE `jokittn_extensions` DISABLE KEYS */;

INSERT INTO `jokittn_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`)
VALUES
	...
	(103,0,'LIB_JOOMLA','library','joomla','',0,1,1,1,'{\"name\":\"LIB_JOOMLA\",\"type\":\"library\",\"creationDate\":\"2008\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2018 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"https:\\/\\/www.joomla.org\",\"version\":\"13.1\",\"description\":\"LIB_JOOMLA_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"joomla\"}','{\"mediaversion\":\"67bf63749737261a343fe43cfd86cb42\"}','','',0,'0000-00-00 00:00:00',0,0),
	...
	(452,0,'plg_system_updatenotification','plugin','updatenotification','system',0,1,1,0,'{\"name\":\"plg_system_updatenotification\",\"type\":\"plugin\",\"creationDate\":\"May 2015\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2018 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"updatenotification\"}','{\"lastrun\":1524610984}','','',0,'0000-00-00 00:00:00',0,0),
	...
	(803,0,'plg_system_kickcleanhead','plugin','kickcleanhead','system',0,1,1,0,'{\"name\":\"plg_system_kickcleanhead\",\"type\":\"plugin\",\"creationDate\":\"3 August 2016\",\"author\":\"Niels Nübel\",\"copyright\":\"Copyright (c) 2009 - 2016 Niels N\\u00fcbel\",\"authorEmail\":\"info@niels-nuebel.de\",\"authorUrl\":\"www.niels-nuebel.de\",\"version\":\"1.0.0\",\"description\":\"PLG_SYSTEM_KICKCLEANHEAD_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"kickcleanhead\"}','{\"loadfirst\":\"\",\"loadonbottom\":\"0\",\"disablejs\":\"1\",\"fnjs\":\"demo.js\",\"jui-jquery\":\"1\",\"jui-jquery-migrate\":\"1\",\"jui-jquery-noconflict\":\"1\",\"jui-bootstrap\":\"1\",\"caption\":\"1\",\"disablecss\":\"1\",\"fncss\":\"\",\"skiptemplate\":\"7\"}','','',860,'2018-04-24 23:06:11',0,0),
	(804,0,'<%= projectname %>','template','<%= projectname %>','',0,1,1,0,'{\"name\":\"<%= projectname %>\",\"type\":\"template\",\"creationDate\":\"19 April 2018\",\"author\":\"<%= projectauthor %>",\"copyright\":\"Copyright (C) 2005 - 2018 Open Source Matters, Inc. All rights reserved.\",\"authorEmail\":\"<%= projectmail %>\",\"authorUrl\":\"\",\"version\":\"0.0.1\",\"description\":\"TPL_<%= projectname.toUpperCase() %>_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"templateDetails\"}','{\"hidecontentwrapper\":\"0\",\"showsystemoutput\":\"0\",\"layout\":\"default.php\"}','','',0,'0000-00-00 00:00:00',0,0);

/*!40000 ALTER TABLE `jokittn_extensions` ENABLE KEYS */;
UNLOCK TABLES;


# Export von Tabelle jokittn_fields
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_fields`;

CREATE TABLE `jokittn_fields` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
# Export von Tabelle jokittn_fields_categories
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_fields_categories`;

CREATE TABLE `jokittn_fields_categories` (
...
# Export von Tabelle jokittn_fields_groups
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_fields_groups`;

CREATE TABLE `jokittn_fields_groups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0',
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
# Export von Tabelle jokittn_fields_values
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_fields_values`;

CREATE TABLE `jokittn_fields_values` (
...
# Export von Tabelle jokittn_finder_filters
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_finder_filters`;

CREATE TABLE `jokittn_finder_filters` (
...
# Export von Tabelle jokittn_finder_links
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_finder_links`;

CREATE TABLE `jokittn_finder_links` (
...
# Export von Tabelle jokittn_finder_links_terms0
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_finder_links_terms0`;

CREATE TABLE `jokittn_finder_links_terms0` (
...
# Export von Tabelle jokittn_finder_links_terms1
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_finder_links_terms1`;

CREATE TABLE `jokittn_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Export von Tabelle jokittn_finder_links_terms2
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_finder_links_terms2`;

CREATE TABLE `jokittn_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Export von Tabelle jokittn_finder_links_terms3
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_finder_links_terms3`;

CREATE TABLE `jokittn_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Export von Tabelle jokittn_finder_links_terms4
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_finder_links_terms4`;

CREATE TABLE `jokittn_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Export von Tabelle jokittn_finder_links_terms5
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_finder_links_terms5`;

CREATE TABLE `jokittn_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Export von Tabelle jokittn_finder_links_terms6
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_finder_links_terms6`;

CREATE TABLE `jokittn_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Export von Tabelle jokittn_finder_links_terms7
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_finder_links_terms7`;

CREATE TABLE `jokittn_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Export von Tabelle jokittn_finder_links_terms8
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_finder_links_terms8`;

CREATE TABLE `jokittn_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Export von Tabelle jokittn_finder_links_terms9
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_finder_links_terms9`;

CREATE TABLE `jokittn_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Export von Tabelle jokittn_finder_links_termsa
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_finder_links_termsa`;

CREATE TABLE `jokittn_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Export von Tabelle jokittn_finder_links_termsb
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_finder_links_termsb`;

CREATE TABLE `jokittn_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Export von Tabelle jokittn_finder_links_termsc
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_finder_links_termsc`;

CREATE TABLE `jokittn_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Export von Tabelle jokittn_finder_links_termsd
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_finder_links_termsd`;

CREATE TABLE `jokittn_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Export von Tabelle jokittn_finder_links_termse
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_finder_links_termse`;

CREATE TABLE `jokittn_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Export von Tabelle jokittn_finder_links_termsf
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_finder_links_termsf`;

CREATE TABLE `jokittn_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
# Export von Tabelle jokittn_finder_taxonomy
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_finder_taxonomy`;

CREATE TABLE `jokittn_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
LOCK TABLES `jokittn_finder_taxonomy` WRITE;
/*!40000 ALTER TABLE `jokittn_finder_taxonomy` DISABLE KEYS */;

INSERT INTO `jokittn_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`)
VALUES
	(1,0,'ROOT',0,0,0);

/*!40000 ALTER TABLE `jokittn_finder_taxonomy` ENABLE KEYS */;
UNLOCK TABLES;


# Export von Tabelle jokittn_finder_taxonomy_map
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_finder_taxonomy_map`;

CREATE TABLE `jokittn_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
# Export von Tabelle jokittn_finder_terms
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_finder_terms`;

CREATE TABLE `jokittn_finder_terms` (
...
# Export von Tabelle jokittn_finder_terms_common
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_finder_terms_common`;

CREATE TABLE `jokittn_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
LOCK TABLES `jokittn_finder_terms_common` WRITE;
/*!40000 ALTER TABLE `jokittn_finder_terms_common` DISABLE KEYS */;

INSERT INTO `jokittn_finder_terms_common` (`term`, `language`)
VALUES
	('a','en'),
	('about','en'),
	('after','en'),
...
/*!40000 ALTER TABLE `jokittn_finder_terms_common` ENABLE KEYS */;
UNLOCK TABLES;


# Export von Tabelle jokittn_finder_tokens
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_finder_tokens`;

CREATE TABLE `jokittn_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
# Export von Tabelle jokittn_finder_tokens_aggregate
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_finder_tokens_aggregate`;

CREATE TABLE `jokittn_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
# Export von Tabelle jokittn_finder_types
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_finder_types`;

CREATE TABLE `jokittn_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
# Export von Tabelle jokittn_languages
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_languages`;

CREATE TABLE `jokittn_languages` (
...
LOCK TABLES `jokittn_languages` WRITE;
/*!40000 ALTER TABLE `jokittn_languages` DISABLE KEYS */;

INSERT INTO `jokittn_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`)
VALUES
	(1,0,X'656E2D4742','English (en-GB)','English (United Kingdom)','en','en_gb','','','','',1,1,1);

/*!40000 ALTER TABLE `jokittn_languages` ENABLE KEYS */;
UNLOCK TABLES;


# Export von Tabelle jokittn_menu
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_menu`;

CREATE TABLE `jokittn_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `jokittn_menu` WRITE;
/*!40000 ALTER TABLE `jokittn_menu` DISABLE KEYS */;

INSERT INTO `jokittn_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`)
VALUES
...
/*!40000 ALTER TABLE `jokittn_menu` ENABLE KEYS */;
UNLOCK TABLES;


# Export von Tabelle jokittn_menu_types
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_menu_types`;

CREATE TABLE `jokittn_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0',
...
LOCK TABLES `jokittn_menu_types` WRITE;
/*!40000 ALTER TABLE `jokittn_menu_types` DISABLE KEYS */;

INSERT INTO `jokittn_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`)
VALUES
	(1,0,'mainmenu','Main Menu','The main menu for the site',0);

/*!40000 ALTER TABLE `jokittn_menu_types` ENABLE KEYS */;
UNLOCK TABLES;


# Export von Tabelle jokittn_messages
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_messages`;

CREATE TABLE `jokittn_messages` (
...
# Export von Tabelle jokittn_messages_cfg
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_messages_cfg`;

CREATE TABLE `jokittn_messages_cfg` (
...
# Export von Tabelle jokittn_modules
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_modules`;

CREATE TABLE `jokittn_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
LOCK TABLES `jokittn_modules` WRITE;
/*!40000 ALTER TABLE `jokittn_modules` DISABLE KEYS */;

INSERT INTO `jokittn_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`)
VALUES
...
/*!40000 ALTER TABLE `jokittn_modules` ENABLE KEYS */;
UNLOCK TABLES;


# Export von Tabelle jokittn_modules_menu
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_modules_menu`;

CREATE TABLE `jokittn_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`moduleid`,`menuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

LOCK TABLES `jokittn_modules_menu` WRITE;
/*!40000 ALTER TABLE `jokittn_modules_menu` DISABLE KEYS */;

INSERT INTO `jokittn_modules_menu` (`moduleid`, `menuid`)
VALUES
	(1,0),
	(2,0),
	(3,0),
...
/*!40000 ALTER TABLE `jokittn_modules_menu` ENABLE KEYS */;
UNLOCK TABLES;


# Export von Tabelle jokittn_newsfeeds
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_newsfeeds`;

CREATE TABLE `jokittn_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
# Export von Tabelle jokittn_overrider
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_overrider`;

CREATE TABLE `jokittn_overrider` (
...
# Export von Tabelle jokittn_postinstall_messages
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_postinstall_messages`;

CREATE TABLE `jokittn_postinstall_messages` (
...
LOCK TABLES `jokittn_postinstall_messages` WRITE;
/*!40000 ALTER TABLE `jokittn_postinstall_messages` DISABLE KEYS */;

INSERT INTO `jokittn_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`)
VALUES
...
/*!40000 ALTER TABLE `jokittn_postinstall_messages` ENABLE KEYS */;
UNLOCK TABLES;


# Export von Tabelle jokittn_redirect_links
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_redirect_links`;

CREATE TABLE `jokittn_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
# Export von Tabelle jokittn_schemas
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_schemas`;

CREATE TABLE `jokittn_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`extension_id`,`version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

LOCK TABLES `jokittn_schemas` WRITE;
/*!40000 ALTER TABLE `jokittn_schemas` DISABLE KEYS */;

INSERT INTO `jokittn_schemas` (`extension_id`, `version_id`)
VALUES
	(700,'3.8.6-2018-02-14');

/*!40000 ALTER TABLE `jokittn_schemas` ENABLE KEYS */;
UNLOCK TABLES;


# Export von Tabelle jokittn_session
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_session`;

CREATE TABLE `jokittn_session` (
...
LOCK TABLES `jokittn_session` WRITE;
/*!40000 ALTER TABLE `jokittn_session` DISABLE KEYS */;

INSERT INTO `jokittn_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`)
VALUES
	('5o4gs3j81e17ttn25aec815do1',1,0,'1524611172','joomla|s:1696:\"\";',860,'kittn'),
	('7ags5p9ckvt4v3ajp60j2gasi6',0,1,'1524611232','joomla|s:664:\"\";',0,''),
	('qarheibe1ch8fb0ovh2b6qg9f4',1,0,'1524141166','joomla|s:868:\"\";',860,'kittn'),
	('vnt94g5otjlc7dfc29h9r4qs56',0,1,'1524611003','joomla|s:664:\"\";',0,'');

/*!40000 ALTER TABLE `jokittn_session` ENABLE KEYS */;
UNLOCK TABLES;


# Export von Tabelle jokittn_tags
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_tags`;

CREATE TABLE `jokittn_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
LOCK TABLES `jokittn_tags` WRITE;
/*!40000 ALTER TABLE `jokittn_tags` DISABLE KEYS */;

INSERT INTO `jokittn_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`)
VALUES
	(1,0,0,1,0,'','ROOT',X'726F6F74','','',1,0,'0000-00-00 00:00:00',1,'','','','',860,'2018-04-19 12:31:56','',0,'0000-00-00 00:00:00','','',0,'*',1,'0000-00-00 00:00:00','0000-00-00 00:00:00');

/*!40000 ALTER TABLE `jokittn_tags` ENABLE KEYS */;
UNLOCK TABLES;


# Export von Tabelle jokittn_template_styles
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_template_styles`;

CREATE TABLE `jokittn_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `jokittn_template_styles` WRITE;
/*!40000 ALTER TABLE `jokittn_template_styles` DISABLE KEYS */;

INSERT INTO `jokittn_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`)
VALUES
	(4,'beez3',0,'0','Beez3 - Default','{\"wrapperSmall\":\"53\",\"wrapperLarge\":\"72\",\"logo\":\"images\\/joomla_black.png\",\"sitetitle\":\"Joomla!\",\"sitedescription\":\"Open Source Content Management\",\"navposition\":\"left\",\"templatecolor\":\"personal\",\"html5\":\"0\"}'),
	(5,'hathor',1,'0','Hathor - Default','{\"showSiteName\":\"0\",\"colourChoice\":\"\",\"boldText\":\"0\"}'),
	(7,'protostar',0,'0','protostar - Default','{\"templateColor\":\"\",\"logoFile\":\"\",\"googleFont\":\"1\",\"googleFontName\":\"Open+Sans\",\"fluidContainer\":\"0\"}'),
	(8,'isis',1,'1','isis - Default','{\"templateColor\":\"\",\"logoFile\":\"\"}'),
	(9,'<%= projectname %>',0,'1','<%= projectname %> - Default','{\"hidecontentwrapper\":\"0\",\"showsystemoutput\":\"0\",\"layout\":\"default.php\"}');

/*!40000 ALTER TABLE `jokittn_template_styles` ENABLE KEYS */;
UNLOCK TABLES;


# Export von Tabelle jokittn_ucm_base
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_ucm_base`;

CREATE TABLE `jokittn_ucm_base` (
...
# Export von Tabelle jokittn_ucm_content
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_ucm_content`;

CREATE TABLE `jokittn_ucm_content` (
...
# Export von Tabelle jokittn_ucm_history
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_ucm_history`;

CREATE TABLE `jokittn_ucm_history` (
...
# Export von Tabelle jokittn_update_sites
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_update_sites`;

CREATE TABLE `jokittn_update_sites` (
...
LOCK TABLES `jokittn_update_sites` WRITE;
/*!40000 ALTER TABLE `jokittn_update_sites` DISABLE KEYS */;

INSERT INTO `jokittn_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`)
VALUES
	(1,'Joomla! Core','collection','https://update.joomla.org/core/list.xml',1,1524610993,''),
	...
	(4,'PLG_SYSTEM_KICKCLEANHEAD','extension','https://raw.githubusercontent.com/nielsnuebel/plg_system_kickcleanhead/master/update.xml',1,0,'');

/*!40000 ALTER TABLE `jokittn_update_sites` ENABLE KEYS */;
UNLOCK TABLES;


# Export von Tabelle jokittn_update_sites_extensions
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_update_sites_extensions`;

CREATE TABLE `jokittn_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`update_site_id`,`extension_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

LOCK TABLES `jokittn_update_sites_extensions` WRITE;
/*!40000 ALTER TABLE `jokittn_update_sites_extensions` DISABLE KEYS */;

INSERT INTO `jokittn_update_sites_extensions` (`update_site_id`, `extension_id`)
VALUES
	(1,700),
	(2,802),
	(3,28),
...
/*!40000 ALTER TABLE `jokittn_update_sites_extensions` ENABLE KEYS */;
UNLOCK TABLES;


# Export von Tabelle jokittn_updates
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_updates`;

CREATE TABLE `jokittn_updates` (
...
# Export von Tabelle jokittn_user_keys
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_user_keys`;

CREATE TABLE `jokittn_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
# Export von Tabelle jokittn_user_notes
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_user_notes`;

CREATE TABLE `jokittn_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
# Export von Tabelle jokittn_user_profiles
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_user_profiles`;

CREATE TABLE `jokittn_user_profiles` (
...
# Export von Tabelle jokittn_user_usergroup_map
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_user_usergroup_map`;

CREATE TABLE `jokittn_user_usergroup_map` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id',
  PRIMARY KEY (`user_id`,`group_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

LOCK TABLES `jokittn_user_usergroup_map` WRITE;
/*!40000 ALTER TABLE `jokittn_user_usergroup_map` DISABLE KEYS */;

INSERT INTO `jokittn_user_usergroup_map` (`user_id`, `group_id`)
VALUES
	(860,8);

/*!40000 ALTER TABLE `jokittn_user_usergroup_map` ENABLE KEYS */;
UNLOCK TABLES;


# Export von Tabelle jokittn_usergroups
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_usergroups`;

CREATE TABLE `jokittn_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
LOCK TABLES `jokittn_usergroups` WRITE;
/*!40000 ALTER TABLE `jokittn_usergroups` DISABLE KEYS */;

INSERT INTO `jokittn_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`)
VALUES
	(1,0,1,18,'Public'),
	(2,1,8,15,'Registered'),
	(3,2,9,14,'Author'),
...
/*!40000 ALTER TABLE `jokittn_usergroups` ENABLE KEYS */;
UNLOCK TABLES;


# Export von Tabelle jokittn_users
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_users`;

CREATE TABLE `jokittn_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `jokittn_users` WRITE;
/*!40000 ALTER TABLE `jokittn_users` DISABLE KEYS */;

INSERT INTO `jokittn_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`)
VALUES
	(860,'Super User','kittn','hello@kittn.de','$2y$10$7hg2T8TiakTw0jJexAB3eu1y2wdwlgYHuP4SMG8L.2VtySRnBjEIO',0,1,'2018-04-19 12:31:56','2018-04-24 23:03:10','0','','0000-00-00 00:00:00',0,'','',0);

/*!40000 ALTER TABLE `jokittn_users` ENABLE KEYS */;
UNLOCK TABLES;


# Export von Tabelle jokittn_utf8_conversion
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_utf8_conversion`;

CREATE TABLE `jokittn_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

LOCK TABLES `jokittn_utf8_conversion` WRITE;
/*!40000 ALTER TABLE `jokittn_utf8_conversion` DISABLE KEYS */;

INSERT INTO `jokittn_utf8_conversion` (`converted`)
VALUES
	(2);

/*!40000 ALTER TABLE `jokittn_utf8_conversion` ENABLE KEYS */;
UNLOCK TABLES;


# Export von Tabelle jokittn_viewlevels
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jokittn_viewlevels`;

CREATE TABLE `jokittn_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.',
...
LOCK TABLES `jokittn_viewlevels` WRITE;
/*!40000 ALTER TABLE `jokittn_viewlevels` DISABLE KEYS */;

INSERT INTO `jokittn_viewlevels` (`id`, `title`, `ordering`, `rules`)
VALUES
	(1,'Public',0,'[1]'),
...
/*!40000 ALTER TABLE `jokittn_viewlevels` ENABLE KEYS */;
UNLOCK TABLES;

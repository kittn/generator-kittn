 ...
 */
class m161220_000000_seomatic_addPriceRange extends BaseMigration
{
	/**
	...
	public function safeUp()
	{
		...
		$newColumns = array (
			'localBusinessPriceRange' => ColumnType::Varchar
		);

		$this->_addColumnsAfter("seomatic_settings", $newColumns, "organizationOwnerContactPoints");
        $this->alterColumn('seomatic_settings', 'localBusinessPriceRange', array(ColumnType::Varchar, 'maxLength' => 10));
